...
void mnu_advance_directory(char* path_main, mnu_file_list* list_pointer){
...
void mnu_unadvance_directory(char* path_main, struct mnu_file_list* list_pointer){
    ...
    // last character useless I think
...
void mnu_main_loop(char* path_main){
    ...
    */
    ...
    while (keep_working){
        ...
        switch (current_stage_number){
            case 0:
                mnu_draw_screen_main(path_main, &main_file_list, lower_limit, upper_limit, cursor_position);
            break;
            case 1:
                // help screen
            break;
            ...
            switch(key_pair.scancode){
                ...
                case key_enter:
                    ...
                    if (main_file_list.are_they_dirs[cursor_position] == 1){
                        mnu_advance_directory(path_main, &main_file_list);
                    }
                ...
                case key_backspace:
                    ...
                    mnu_unadvance_directory(path_main, &main_file_list);
